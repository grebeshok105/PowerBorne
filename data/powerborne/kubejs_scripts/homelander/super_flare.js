PlayerEvents.tick((event) => {
    ...
    if (abilityUtil.isEnabled(player, "powerborne:homelander", "super_flare")) {
        player.modifyAttribute("palladium:flight_speed", "super_flare", -10, "multiply_base");
        let currentTick = global.getAbilityAnimationTicks(player, "powerborne:homelander", "super_flare", true);
        let range = 25;
